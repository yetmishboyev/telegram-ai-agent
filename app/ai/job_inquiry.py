...
_JOB_PATTERNS: list[re.Pattern] = [
    ...
    re.compile(r"\bish\s+bor(?:mi|ma)?\b", re.I),               # "ish bormi"
...
# CV/obyektivka so'raladi. Va'da berilmaydi — ega hech kimni ishga olishga
# majbur emas, agent esa vakansiya bor-yo'qligini bilmaydi.
JOB_INQUIRY_REPLIES: dict[str, str] = {
    "uz": (
        "Ish bo'yicha murojaatingizni Shaxzodbek Yetmishboyevga yetkazaman. "
        "Iltimos, CV yoki obyektivkangizni shu yerga yuboring — "
        "Shaxzodbek ko'rib chiqib, o'zi javob beradi."
    ),
    "ru": (
        "Ваш вопрос по работе я передам Шахзодбеку Йетмишбоеву. "
        "Пожалуйста, отправьте сюда своё резюме — "
